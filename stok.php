...
if(isset($_GET["idsa"])) {
	...
	if (!empty($idpekerja)) {
        $pQuery = mysqli_query($con, "SELECT * FROM report WHERE idpekerja = '$idpekerja'");
    ...
    $query = mysqli_query($con, "SELECT * FROM report WHERE idpekerja = '$idpekerja'");
...
<div class="main-content">
	...
	<div class="card-container">
		<h3 class="main-title">Stok Minyak Bengkel</h3>
			<div class="card-wrapper">
				<div class="data-card">
					<div class="card-header">
						<div class="data">
						<span class="title">
							<a class="btn btn-info" href="lapor.php?idsa=<?php echo $idpekerja;?>">Tambah Stok</a>
						</span><br><br>
						<span class="card-detail">
						<table class="table table-bordered" id="data" border="5px" cellspacing="0" cellpadding="5">
							<tr>
								<th onclick="sortTable(0)">JENIS MINYAK : KUANTITI</th>
								<th onclick="sortTable(1)">TARIKH LAPORAN</th>
								<th onclick="sortTable(2)">TINDAKAN</th>
							</tr>
							<?php
							include '../config.php';
							$show = mysqli_query($con, "SELECT * FROM report WHERE idpekerja = $idpekerja");
							while ($res = mysqli_fetch_array($show)) {
									...
									echo "<td><button class='btn btn-danger' type='submit' name='del_report'>Delete</button></td>";
									echo "</form>";
									echo "</tr>";
							}
							?>
